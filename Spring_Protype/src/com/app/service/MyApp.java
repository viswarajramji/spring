...
public class MyApp {
	public static void main(String[] args) {
	    ...
	    coach1 = context1.getBean("baseBallPrototype", Coach.class);
		coach2 = context1.getBean("baseBallPrototype", Coach.class);
		//scope prototype will return single ton class
		System.out.println(coach1==coach2);
		context1.close();
	}
}
